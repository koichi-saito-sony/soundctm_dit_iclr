...
import torch
import librosa
from sa_edm.clap_modified.clap_module_modified import create_model
from transformers import RobertaTokenizer
import wget
from sa_edm.clap_modified.clap_module_modified.factory import load_state_dict
import torchaudio
import numpy as np
...
class CLAP_Module_modified(torch.nn.Module):
    def __init__(self, enable_fusion=False, device=None, amodel= 'HTSAT-tiny', tmodel='roberta', projection=True) -> None:
        ...
        """
        super(CLAP_Module_modified, self).__init__()
        if device is None:
